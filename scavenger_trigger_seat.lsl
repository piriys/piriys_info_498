...
string TRIGGER_ID = "Calmness Token Dispenser"; //Object name - Make sure this matches with the object settings in scavenger_object.lsl, meaningful name preferred
integer ACTIVATION_TIME = 15;  //Time until object disappears (seconds) after being activated (make sure ALWAYS_VISIBLE = FALSE in the scavenger_object.lsl)
...
default
{
    ...
    timer()
    {
        llSay(PUBLIC_CHANNEL, "Don't you feel calmer already? Great job, the Calmness Token is now available for you to collect!");
