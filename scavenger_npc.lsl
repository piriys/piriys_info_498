...
default
{
    ...
    touch_end(integer num_detected)
    {
        ...
        string parameter = TRIGGER_ID + "***" + NPC_TEXTURE + "***" + llDumpList2String(DIALOGUE_OPTIONS, "###");
        
        string xorParameterList = Xor(timeStamp + "," + triggerID + "," + command + "," + parameter, XOR_KEY + avatarKey);
